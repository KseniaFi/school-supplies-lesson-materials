    ...
    <style>
        * {
        ...
        @keyframes writeWord {
            ...
            100% { 
                transform: translateX(calc(100% - 80px)) rotate(45deg);
            }
        }
    ...
    <script>
                ...
                <div class="flashcard-inner">
                    ...
                    <div class="flashcard-back">
                        ...
                        <div class="word-container">
                            ...
                            <img class="pen" src="${penImage}" alt="Pen" onerror="this.style.display='none'">
                        </div>
                    </div>
                </div>
            `;
        ...
        function createSparkleEffect(cardElement) {
            ...
            for (let i = 0; i < sparkleCount; i++) {
                ...
                // Random color
                const colors = ['gold', 'silver', '#ff6b6b', '#4ecdc4', '#ffe66d', '#ff9ff3', '#54a0ff', '#ff7979'];
        ...
        // Create glitter effect function
        function createGlitterEffect(cardElement) {
            ...
            cardElement.appendChild(glitterOverlay);
            ...
            for (let i = 0; i < glitterCount; i++) {
                ...
                glitter.style.animationDelay = `${delay}ms`;
                
                glitterOverlay.appendChild(glitter);
            }
            
            // Remove glitter overlay after animation
            setTimeout(() => {
                if (glitterOverlay.parentNode) {
                    glitterOverlay.parentNode.removeChild(glitterOverlay);
                }
            }, 2500);
        }
        ...
        musicControl.addEventListener('click', function() {
            if (musicPlaying) {
                ...
                musicPlaying = true;
                this.style.boxShadow = '0 0 15px rgba(46, 204, 113, 0.7)';
            }
        });
        ...
        document.addEventListener('click', function initAudio() {
            if (!musicPlaying) {
                ...
                backgroundMusic.play().then(() => {
                    musicPlaying = true;
                    musicControl.style.boxShadow = '0 0 15px rgba(46, 204, 113, 0.7)';
                }).catch(e => {
